...
(function (global, factory) {
  ...
  (factory((global.cubism = {}),global.d3));
  ...
  var formatSeconds$1 = timeFormat('%I:%M:%S %p');
  var formatMinutes$1 = timeFormat('%I:%M %p');
  var formatDays = timeFormat('%B %d');
  var formatDefault = function formatDefault(context) {
    return context.step() < 6e4 ? formatSeconds$1 : context.step() < 864e5 ? formatMinutes$1 : formatDays;
  };

  var apiRemove = function apiRemove(axisState) {
    return {
      remove: function remove(selection$$1) {
        var context = axisState.context;

        selection$$1.selectAll('svg').each(function (d) {
  ...
  var apiRender = function apiRender(context, state) {
    return {
      render: function render(selection$$1) {
        ...
        var g = selection$$1.append('svg').datum({ id: id }).attr('width', size).attr('height', Math.max(28, -_axis.tickSize())).append('g').attr('transform', 'translate(0,' + 4 + ')').call(_axis);
  ...
  var apiRender$2 = function apiRender(context, state) {
    return {
      render: function render(selection$$1) {
        selection$$1.append('div').attr('a', 'b');
        ...
        selection$$1.on('mousemove.horizon', function () {
        ...
        selection$$1.append('canvas').attr('width', _width).attr('height', _height);

        selection$$1.append('span').attr('class', 'title').text(_title);

        selection$$1.append('span').attr('class', 'value');
    ...
    return {
      horizon: function horizon() {
        ...
        var state = {
          ...
          _scale: linear$1().interpolate(interpolateRound),
          _metric: function _metric(d) {
            return d;
          },
          _extent: null,
  ...
  var apiRender$3 = function apiRender(state) {
    return {
      render: function render(selection$$1) {
        ...
        selection$$1.on('mousemove.comparison', function () {
        ...
        selection$$1.append('span').attr('class', 'value primary');
        selection$$1.append('span').attr('class', 'value change');
